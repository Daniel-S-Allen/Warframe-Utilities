...
/////////////////////////////////////////////////////////////////////////
	...
	case CE_HeaderLabel: {
		...
		if (!header->icon.isNull()) {
			...
			painter->drawPixmap(inter.x(), inter.y(), pixmap, inter.x() - aligned.x(),inter.y() - aligned.y(),(int)(aligned.width() * pixmap.devicePixelRatio()),(int)(pixmap.height() * pixmap.devicePixelRatio()));
			int margin =
		...
		proxy()->drawItemText(painter,rect,	header->textAlignment, header->palette, (header->state & State_Enabled), header->text,QPalette::ButtonText);
...
void PhantomStyle::polish(QPalette& palette) {
	// modify palette to dark
	palette.setColor(QPalette::Window, QColor(21, 21, 21, 150));
